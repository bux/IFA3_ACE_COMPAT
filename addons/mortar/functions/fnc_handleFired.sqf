...
if (!ace_mk6mortar_airResistanceEnabled) exitWith {};
...
}, 0, [_projectile, ruPal_RHS_Artillery_AIR_FRICTION, ACE_time, _relativeDensity]] call CBA_fnc_addPerFrameHandler;
