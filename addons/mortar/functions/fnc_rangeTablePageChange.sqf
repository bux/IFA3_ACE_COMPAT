...
#define RANGE_TABLE       ((uiNamespace getVariable "ACE_D30_RangeTable_Dialog") displayCtrl 20001)
#define LIST_CHARGE       ((uiNamespace getVariable "ACE_D30_RangeTable_Dialog") displayCtrl 1501)
...
//была произведена замена GVAR(airResistanceEnabled) на ace_mk6mortar_airResistanceEnabled.
_airFriction = if (ace_mk6mortar_airResistanceEnabled) then {ruPal_RHS_Artillery_AIR_FRICTION} else {0};
