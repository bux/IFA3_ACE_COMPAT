...
_weaponName = "LIB_BM37_ACE";

createDialog "ACE_D30_RangeTable_Dialog";
if (isNull (uiNamespace getVariable ["ACE_D30_RangeTable_Dialog", displayNull])) exitWith {ERROR("Dialog failed to open");};
